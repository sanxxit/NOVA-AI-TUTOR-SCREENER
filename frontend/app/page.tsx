...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#09090B] text-slate-900 dark:text-white">
      ...
      >
        <span className="text-sm font-semibold text-slate-900 dark:text-white tracking-tight">Nova</span>
      ...
      <main className="pt-14">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
            ...
            <div className="space-y-8 animate-fade-in">
              <div className="space-y-5">
                ...
                <p className="text-slate-500 dark:text-zinc-500 text-base leading-relaxed">
              ...
              <div className="border-l border-slate-200 dark:border-white/[0.08] pl-4">
                <p className="text-[11px] text-slate-400 dark:text-zinc-700 mb-1.5">The kind of question Nova asks</p>
            ...
            <div id="hero-form" className="animate-fade-in" style={{ animationDelay: '0.12s' }}>
              <div className="space-y-6">
                ...
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-slate-400 dark:text-zinc-600">Under 15 minutes. Voice only.</p>
                </div>
                ...
                {micState === 'idle' && (
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-slate-400 dark:text-zinc-700 text-center">
                ...
                {micState === 'requesting' && (
                  <div className="w-full flex items-center justify-center gap-3 py-5 rounded-xl bg-slate-100 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.08]">
                    ...
                    <span className="text-sm text-slate-500 dark:text-zinc-500">Requesting microphone access…</span>
                  </div>
                )}
                ...
                {micState === 'denied' && (
                  <div className="space-y-3">
                    <div className="rounded-xl px-5 py-4 space-y-2 bg-red-50 dark:bg-red-500/[0.06] border border-red-200 dark:border-red-500/[0.25]">
                      ...
                      <p className="text-xs text-slate-500 dark:text-zinc-600">Check your browser settings and allow mic access, then refresh.</p>
                    </div>
                    <button
                      onClick={skipMicCheck}
                      className="w-full text-xs text-slate-400 dark:text-zinc-600 hover:text-slate-600 dark:hover:text-zinc-400 underline transition-colors py-2"
                    >
                  ...
                  <div className="rounded-xl px-5 py-4 space-y-3 bg-slate-100 dark:bg-white/[0.03] border border-slate-200 dark:border-white/[0.07]">
                    ...
                    <div className="flex items-center justify-center gap-2">
                      {micState === 'detected' ? (
                        ...
                        <span className="text-xs text-slate-400 dark:text-zinc-600">Say something to test your microphone…</span>
                      )}
                    </div>
                  </div>
                )}
                  ...
                  <form onSubmit={handleSubmit} noValidate className="space-y-4 pt-1">
                    <div className="space-y-3">
                      <div className="space-y-1.5">
                        <label className="text-[11px] font-medium text-slate-500 dark:text-zinc-600 uppercase tracking-wider">
                          Your Name
                        </label>
                        <input
                          ref={nameInputRef}
                    ...
                    <div className="pt-1 border-t border-slate-200 dark:border-white/[0.07] space-y-1.5">
                      <p className="text-[11px] text-slate-400 dark:text-zinc-700 text-center">Your details are only used for this screening.</p>
          ...
          <div className="max-w-5xl mx-auto px-6 py-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-3">
                ...
                <p className="text-slate-500 dark:text-zinc-600 text-sm leading-relaxed max-w-sm">No installation. No account. Just a browser and a microphone.</p>
              </div>
              <ol className="space-y-6">
                {[
                  ...
                  <li key={item.step} className="flex gap-5">
                    <span className="w-6 h-6 rounded-full border border-slate-300 dark:border-white/[0.12] text-[11px] font-bold text-slate-400 dark:text-zinc-500 flex items-center justify-center flex-shrink-0 mt-0.5">
                      {item.step}
                    </span>
                    <div className="space-y-0.5 pt-0.5">
                      <p className="text-sm font-semibold text-slate-900 dark:text-white">{item.title}</p>
                      <p className="text-xs text-slate-500 dark:text-zinc-600 leading-relaxed">{item.body}</p>
                    </div>
                  </li>
                ))}
              </ol>
          ...
          <div className="max-w-5xl mx-auto px-6 py-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-4">
                ...
                <p className="text-slate-500 dark:text-zinc-500 text-sm leading-relaxed">We are not testing your knowledge of mathematics. What is harder to find — and what we actually screen for — is this:</p>
                <p className="text-xs text-slate-400 dark:text-zinc-700 leading-relaxed border-l border-slate-200 dark:border-white/[0.08] pl-3">
                ...
                {SKILLS.map((s) => (
                  <li key={s.name} className="flex gap-4 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 dark:text-zinc-600">{s.desc}</p>
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <div className="max-w-5xl mx-auto px-6 py-20">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              <div className="space-y-4">
                ...
                <p className="text-slate-500 dark:text-zinc-500 text-sm leading-relaxed">We open new tutor cohorts in batches. Leave your email and we will reach out when the next round opens. No spam.</p>
              </div>
              <div>
                {waitlistSubmitted ? (
                  <div className="flex items-start gap-3 border border-slate-200 dark:border-white/[0.10] rounded-lg px-5 py-4 bg-slate-50 dark:bg-white/[0.03]">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 dark:text-zinc-600 mt-0.5">We'll reach out when the next cohort opens.</p>
                    </div>
                  </div>
                ) : (
        ...
        <footer className="border-t border-slate-200 dark:border-white/[0.06] px-6 py-5">
          <p className="text-center text-slate-300 dark:text-zinc-800 text-xs">
